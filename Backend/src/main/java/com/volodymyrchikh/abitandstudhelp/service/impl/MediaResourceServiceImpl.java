...
public class MediaResourceServiceImpl implements MediaResourceService {
    ...
    public MediaResourceResponse getById(UUID id) {
        return repository.findById(id)
                ...
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "MediaResource not found"));
    }
    ...
    public void delete(UUID id) {
        if (!repository.existsById(id)) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "MediaResource not found");
        }
