...
public class RegisterRequest {
    ...
    @Pattern(regexp = PASSWORD_REGEX,
            message = "Пароль має бути мінімум 8 символів, використовуючи цифри та латинські літери, " +
            "містити принаймні одну цифру, одну велику літеру та одну малу літеру")
